...
class GeneralSettingsController extends GetxController {
    ...
    // print("prod.discountType : ${prod.discountType}");
      ...
      if (prod.hasDeal != null) {
        if (prod.product.productType == 1) {
          print("priceTex3:: ${singlePrice(sellingPrice(double.parse(prod.skus.first.sellingPrice), prod.hasDeal.discountType, double.parse(prod.hasDeal.discount.toString())))}");
          print("prod.hasDeal.discount ${double.parse(prod.hasDeal.discount.toString()).runtimeType}");
          priceText = singlePrice(sellingPrice(double.parse(prod.skus.first.sellingPrice),
              prod.hasDeal.discountType,double.parse(prod.hasDeal.discount.toString()))).toStringAsFixed(2);
        } else {
          if (sellingPrice(double.parse(prod.minSellPrice), prod.hasDeal.discountType, double.parse(prod.hasDeal.discount.toString())) ==
              sellingPrice(double.parse(prod.maxSellingPrice), prod.hasDeal.discountType, double.parse(prod.hasDeal.discount.toString()))) {
            print("priceText4:: ${singlePrice(sellingPrice(double.parse(prod.minSellPrice), prod.hasDeal.discountType, double.parse(prod.hasDeal.discount.toString())))}");
            priceText = singlePrice(sellingPrice(double.parse(prod.minSellPrice),
                prod.hasDeal.discountType, double.parse(prod.hasDeal.discount.toString())))
                .toStringAsFixed(2);
          } else {
            // print("${prod.productName} -- ${prod.product.productType} -- Max: ${prod.maxSellingPrice} -- Min: ${prod.minSellPrice}");
            print("priceText5:: ${singlePrice(sellingPrice(double.parse(prod.minSellPrice), prod.hasDeal.discountType, double.parse(prod.hasDeal.discount.toString())))}");
  ...
  dynamic calculatePrice(ProductModel prod) {
    ...
    if (prod.hasDeal != null) {
      if (prod.product.productType == 1) {
        ...
        if (sellingPrice(double.parse(prod.minSellPrice), prod.hasDeal.discountType,
                double.parse(prod.hasDeal.discount.toString())) == sellingPrice(double.parse(prod.maxSellingPrice), prod.hasDeal.discountType,
            double.parse(prod.hasDeal.discount.toString()))) {
