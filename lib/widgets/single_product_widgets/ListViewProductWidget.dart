                        ...
                        ? Container(
                            ...
                            child: Text(
                              widget.productModel.hasDeal.discountType == 0
                                  ? '${double.parse(widget.productModel.hasDeal.discount.toString()).toString()}% '
                                  : '${(double.parse(widget.productModel.hasDeal.discount.toString()) * currencyController.conversionRate.value).toStringAsFixed(2)}${currencyController.appCurrency.value} ',
                              textAlign: TextAlign.center,
                              style: AppStyles.appFontBook.copyWith(
                                color: Colors.white,
                                fontSize: 12,
