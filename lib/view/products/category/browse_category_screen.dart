...
class _BrowseCategoryScreenState extends State<BrowseCategoryScreen> {
  ...
  void didChangeDependencies() {
    ...
    categoryFuture.then((value) {
      setState(() {
        currentCategory = value.data.data.where((element) => element.parentId == "0").first.id;

        subCategoryFuture = getSubCategory(value.data.data.where((element) => element.parentId == "0").first.id);
