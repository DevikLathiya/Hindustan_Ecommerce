...
class OrderAllToPayListDataWidget extends StatelessWidget {
  ...
  String deliverStateName(Package package) {
    ...
    package.processes.forEach((element) {
      if (package.deliveryStatus == element.id.toString()) {
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            '${(double.parse(order.packages[packageIndex].products[productIndex].price) * currencyController.conversionRate.value).toStringAsFixed(2)}${currencyController.appCurrency.value}',
                                                            style: AppStyles
                                                                .appFontBook
                                                                .copyWith(
                                                              fontSize: 12,
